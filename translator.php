...
Plugin URI: https://wordpress.org/plugins/translator/
Description: Translates your blog to 35 languages with just one click via the great google translation service.
Version: 0.3
Author: translator 
Author URI: https://wordpress.org/plugins/translator/
*/
...
class Translator {
  ...
  function Translator() {
    ...
    $this->version    = '0.3';
    $this->plugin_url = 'https://wordpress.org/plugins/translator/';
...
<?php
  ...
  function getCode() {
    ...
    return sprintf('<div id="%s"><form action="http://translate.google.com/translate" target="_blank"><input type="hidden" name="u" value="%s" /><select name="tl" onchange="this.form.submit();"><option value="-1">%s</option>%s</select></form><small><a href="https://wordpress.org/plugins/translator/" target="_blank">%s Plugin</a></small></div>', $this->id, get_bloginfo('wpurl'), __('Translate to', $this->id), $data, $this->title);
  }
}
